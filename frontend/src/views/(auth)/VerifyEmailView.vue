...
<template>
  ...
  <CardContent class="space-y-4">
    <p v-if="status === 'verifying'" class="text-muted-foreground text-sm">Verifying your email…</p>

    <template v-else-if="status === 'success'">
      <Alert class="border-emerald-200 bg-emerald-50 text-emerald-800">
        <AlertDescription
          >Your email is verified. You can continue using your account.</AlertDescription
        >
      </Alert>
